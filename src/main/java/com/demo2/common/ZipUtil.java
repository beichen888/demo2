...
public class ZipUtil {
     ...
     */
    public static File[] unzip(String zip, String dest, String password) throws AppException {
     ...
     * @throws ZipException 压缩文件有损坏或者解压缩失败抛出
     */
    public static File[] unzip(String zip, String password) throws AppException {
        File zipFile = new File(zip);
     ...
     * @throws ZipException 压缩文件有损坏或者解压缩失败抛出
     */
    public static File[] unzip(File zipFile, String dest, String password) throws AppException {
        try {
